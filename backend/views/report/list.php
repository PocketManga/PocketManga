            ...
            <tbody>
                <?php if($Reports){ foreach($Reports as $Report){ ?>
                    <tr class="tr_list1">
                        ...
                        <td class="border-b-2px-solid-color3 p-0 text-center"><a class="text-color2 no-hover" href="<?=Yii::$app->request->baseUrl.'/'.'report/'.$Report->IdReport?>"><div class="w-100 h-100 p-3"><?=($Report->Resolved)?'Yes':'No'?></div></a></td>
