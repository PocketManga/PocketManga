...
<div class="modal fade" id="updateRole" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-group needs-validation mb-0" id="form-manager-change" action="<?=Yii::$app->request->baseUrl.'/'.'manager/'.$model->IdManager.'/'.'update/'.$Role->name?>" method="post">
                ...
                <div class="modal-body text-gray-800 pl-4 pr-5">
                    <div class="form-row mt-2 mb-3">
                        <div class="col-12">
                            ...
                            <select class="custom-select" name="role" id="role" onChange="ChangeFormAction('<?=Yii::$app->request->baseUrl.'/'.'manager/'.$model->IdManager.'/'.'update/'?>')">
