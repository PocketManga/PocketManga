...
<div class="server-view row p-4">
    ...
    <div class="col-2">
        <?= Html::a('Update', Yii::$app->request->baseUrl.'/'.'server/'.$model->IdServer.'/'.'update', ['class' => 'btn btn-primary w-100']) ?>
    </div>
    <div class="col-2">
        <?= Html::a('Delete', Yii::$app->request->baseUrl.'/'.'server/'.$model->IdServer.'/'.'delete', [
    ...
    <div class="col-12 mt-4 ts-25">
        <div class="row bold">
            ...
            <div class="col-6 mb-4">
                <p class="text-color1">Code: <span class="text-color2 no-bold"><?=$model->Code?></span></p>
            </div>
        </div>
    </div>
    
    <div class="col-12">
        <p class="text-color2">Server's Mangas</p>
    </div>
