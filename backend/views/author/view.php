...
<div class="author-view row p-4">
    ...
    <div class="col-2">
        <?= Html::a('Update', Yii::$app->request->baseUrl.'/'.'author/'.$model->IdAuthor.'/'.'update', ['class' => 'btn btn-primary w-100']) ?>
    </div>
    <div class="col-2">
        <?= Html::a('Delete', Yii::$app->request->baseUrl.'/'.'author/'.$model->IdAuthor.'/'.'delete', [
    ...
    <div class="col-12 ts-25 mt-4 pt-4 border-t-2px-solid-color3">
        <div class="row bold">
            <div class="col-6 mb-4">
                <p class="text-color1">First Name: <span class="text-color2 no-bold"><?=$model->FirstName?></span></p>
            </div>
            <div class="col-6 mb-4">
                <p class="text-color1">Last Name: <span class="text-color2 no-bold"><?=$model->LastName?></span></p>
            </div>
        </div>
    </div>
    
    <div class="col-12">
        <p class="text-color2">Author's Mangas</p>
    </div>
